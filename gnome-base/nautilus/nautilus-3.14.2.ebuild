...
COMMON_DEPEND="
	...
	tracker? ( >=app-misc/tracker-1.2.2:= )
...
PDEPEND="
	...
	previewer? ( >=gnome-extra/sushi-3.12.0 )
	sendto? ( >=gnome-extra/nautilus-sendto-3.8.0 )
	>=gnome-base/gvfs-1.22.0[gtk]
"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-3.14.0-avoid-unreadable-names.patch
	epatch "${FILESDIR}"/${PN}-3.14.0-remove-useless-boolean-flag.patch
