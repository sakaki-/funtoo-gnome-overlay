...
COMMON_DEPEND="
	>=app-accessibility/at-spi2-atk-2.14.0
	>=dev-libs/atk-2[introspection]
	>=app-crypt/gcr-3.14.0[introspection]
	>=dev-libs/glib-2.42.0:2
	>=dev-libs/gjs-1.42.0
	>=dev-libs/gobject-introspection-1.42.0
	>=x11-libs/gtk+-3.14.0:3[introspection]
	>=media-libs/clutter-1.20.0:1.0[introspection]
	...
	bluetooth? ( >=net-wireless/gnome-bluetooth-3.14.0[introspection] )
	networkmanager? (
		app-crypt/libsecret
...
RDEPEND="${COMMON_DEPEND}
	...
	>=gnome-base/gnome-control-center-3.14.0[bluetooth(+)?]
...
PDEPEND=">=gnome-base/gdm-3.14.0[introspection]
"
